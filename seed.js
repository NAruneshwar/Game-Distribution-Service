...
const main = async () =>{
    ...
    try{
        newgame1 = await games.create("World Of Tanks",["img1","img2"],["action","strategy shooter"],"24GB",["Windows 10","Mac OS high sierra"],["English","German","French","italian"],"17+","https://worldoftanks.asia/","9.1",["aljeghjadlhg"],'19.99');
        console.log(newgame1);
        newgame2 = await games.create("COD",["img32525235","img215135135"],["action","fps"],"11GB",["Windows 10","Android 10+"],["English","Hindi","cantonese"],"27+","https://www.callofduty.com/home","8.6",[""],'22.22');
        // console.log(newgame2);
        allresult = await games.getAll();
        console.log(allresult);
        user1 = await users.create("Arun","Nalluri","Artt","22","arun.nalluri@gmail.com","yes","NY","USA","aelighaljg;gkagladnglkadnn")
        // console.log(user1)
